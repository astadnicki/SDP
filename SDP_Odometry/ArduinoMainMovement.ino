...
int driveLeft(int speed, float deg) {
  ...
  int timeDelay = percentAngle * 660; // 290 is the time for a 90 degree turn to occur if pulse is 580
  int pulse = 130;
  if (pulse < 130) {
    pulse = 130;
  }
...
int driveRight(int speed, float deg) { // 100% means 90 degree turn
  float percentAngle = deg/100;
  int timeDelay = percentAngle * 660; // 290 is the time for a 90 degree turn to occur if pulse is 130, 180 degrees for 590 or 100% deg
  int pulse = 130;
  if (pulse < 130) {
    pulse = 130;
  }
